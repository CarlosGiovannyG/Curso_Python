""" se define una clase padre con su respectivo constructor, a esta clase se le
    asignan los atributos en común de cada objeto que vayamos a crear. 
    * Se crea un método o función en el cul especificamos la operación o acción
    que va a realizar.
    Luego podemos crear otra clase sin necesidad de darle un nuevo constructor, 
    para eso dentro del paréntesis se nombra la clase padre para que esta herede
    de dicha función los atributos y los métodos que contenga.
    ...
    los parámetros que contiene el constructor de la clase PADRE, sin la palabra SELF. 
    y estos mismos los definimos dentro del constructor de la clase HIJA enseguida de 
    la palabra SELF y por ultimo los parámetros que le vamos a agregar. 
